...
const ShopCart = () => {
  return (
    <div className='min-h-[100vh] text-white px-[10vh] py-[8vh]'>
      ...
      <div className="rounded-lg bg-[transparent] border-2 border-[#2E2E2E] px-8 py-8">

        {/* БЛОК ТОВАРА */}
        <div className="flex items-center flex-wrap border-2 border-[#2E2E2E] p-4 justify-between sm:gap-[50px] sm:flex-col">
      ...
      <div className="flex justify-between mt-5 sm:flex-col sm:items-center">
        ...
        <div className="  items-center flex flex-col">
          ...
          <button className=" w-44 h-10 rounded-lg border-2 bg-main border-none text-white hover:text-gray-700 font-bold duration-300">Оплатить сейчас</button>
        </div>
      </div>
    </div>
  )
